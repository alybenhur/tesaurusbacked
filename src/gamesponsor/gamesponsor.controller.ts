...
// =====================================================
// ENDPOINTS NUEVOS: Agregar al gamesponsor.controller.ts
// Agregar después de la sección "CONSULTAS Y BÚSQUEDAS"
// =====================================================

/**
 * Obtener juegos disponibles para un sponsor
 * GET /gamessponsors/sponsors/:sponsorId/available-games
 * 
 * Devuelve juegos que:
 * - Están en estado 'waiting'
 * - No tienen asociación previa con este sponsor
 */
@Get('sponsors/:sponsorId/available-games')
async getAvailableGamesForSponsor(
  @Param('sponsorId') sponsorId: string
) {
  const games = await this.gameSponsorService.getAvailableGamesForSponsor(sponsorId);
 ...
 * GET /gamessponsors/sponsors/:sponsorId/available-games/stats
 */
@Get('sponsors/:sponsorId/available-games/stats')
async getAvailableGamesStatsForSponsor(
  @Param('sponsorId') sponsorId: string
) {
  const stats = await this.gameSponsorService.getAvailableGamesStatsForSponsor(sponsorId);
