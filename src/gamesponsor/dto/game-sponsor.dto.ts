...
// =====================================================
// DTO NUEVO: Agregar al final de game-sponsor.dto.ts
// =====================================================

/**
 * DTO para respuesta de juegos disponibles
 */
export class AvailableGameForSponsorDto {
  _id: string;
  name: string;
  description: string;
  adminId: string;
...
/**
 * DTO para estadísticas de juegos disponibles
 */
export class AvailableGamesStatsDto {
